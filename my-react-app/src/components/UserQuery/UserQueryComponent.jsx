            ...
            >
              ...
              {selectedComponent ? (
                <div className="space-y-4">
                  <div>
                    <h4 className="font-medium text-gray-900 mb-2">{selectedComponent.name}</h4>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{selectedComponent.max_length}</span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 text-sm">
                    Select a component to view details and test it
                  </p>
                </div>
              )}
            </motion.div>
